	...
	<div class="cta__inner inner">
		...
		<ul class="accordion">
            <li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-learning" inert>
                    <p>
            ...
            <li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-sharing" inert>
                    <p>
		...
		<ul class="accordion">
    		<li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-connection" inert>
                    <p>
            ...
            <li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-employment" inert>
                    <p>
    		...
    		<li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-question-about-partners" inert>
                    <p>
            ...
            <li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-collaboration" inert>
                    <p>
		...
		<ul class="accordion">
    		<li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-interview" inert>
                    <p>
            ...
            <li class="accordion__item">
                ...
                <div class="accordion__panel" id="faq-support" inert>
                    <p>
